...
const LinkTree = ({ userId, onSave }) => {
  ...
  return (
    <div className="h-screen w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Left Section */}
        <div className="flex-1 bg-white w-full rounded-lg shadow-xl p-4 sm:p-6">
          <h1 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4">Customize your links</h1>
          <p className="mb-4 sm:mb-6 text-sm sm:text-base">
            Add/edit/remove links below and reorder them to share your profiles with the world!
          </p>
        ...
        {/* Right Section */}
        <div className="w-full max-w-md mx-auto bg-white rounded-3xl shadow-lg p-4 sm:p-6">
